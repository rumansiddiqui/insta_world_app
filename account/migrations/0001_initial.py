# Generated by Django 4.1.7 on 2023-03-17 07:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(upload_to=account.models.user_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('comments', models.ManyToManyField(blank=True, related_name='post_comment', to='account.comment')),
